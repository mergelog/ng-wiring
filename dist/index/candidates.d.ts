...
export declare function buildIndexedCandidates(context: AnalysisContext, catalog: Catalog, index: TemplateIndex, target: Target, maze?: MazeGraph): IndexedCandidate[];
