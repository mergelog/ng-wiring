...
through P7 in [x-tasks.md](x-tasks.md): project contexts, the pinned ngmaze JSON
adapter, Angular scope and element indexing, projection, TemplateRef display
paths, route/bootstrap reconstruction with outlet placement, and control-flow
blocks with the finitization limits around them. Operation tracing and report
rendering are still under development. The command validates arguments and
