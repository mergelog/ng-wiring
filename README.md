...
through P12 in [x-tasks.md](x-tasks.md): project contexts, the pinned ngmaze JSON
...
method, URL, used types and the consumer that starts them. The intermediate
model and report rendering are still under development. The command validates
arguments and reports that the analysis backend is unavailable; it does not
claim to produce a wiring report yet.
...
[x-structure.md](x-structure.md). The P3–P12 APIs are library entry points until
