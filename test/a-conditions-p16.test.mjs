...
test('the acceptance table carries A01 to A24 with three separate states each', async () => {
...
test('no acceptance condition claims a fixture or a CI check ahead of its implementation', async () => {
...
test('the conditions P16 completed are marked in the table', async () => {
