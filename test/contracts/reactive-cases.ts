...
const ledger: ReactiveCase[] = [
  ...
  entry({ contract: 'R15', id: 'R15/rxjs.from', package: 'rxjs', export: 'from', version: RXJS,
    ...
    demonstratedBy: rxjsConsume('data-id=fromButton'),
    missingFixture: 'rxjs-consume の fromButton で Promise からの変換が辺として現れない（R15 未達）' }),
  entry({ contract: 'R15', id: 'R15/rxjs.distinctUntilChanged', package: 'rxjs', export: 'distinctUntilChanged',
    ...
    demonstratedBy: rxjsConsume('data-id=ofButton'),
    missingFixture: 'rxjs-consume の distinctUntilChanged が条件付き通過として辺に現れない（R15 未達）' }),
