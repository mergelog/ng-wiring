...
const ledger: ReactiveCase[] = [
  ...
  entry({ contract: 'R09', id: 'R09/createFeature', package: '@ngrx/store', export: 'createFeature', version: NGRX,
    ...
    demonstratedBy: ngrxApis('data-id=featureButton'),
    missingFixture: 'ngrx-apis の featureButton は dispatch までは載るが、createFeature の中の reducer が object literal 内にあるため検出されず、受信も state 更新も現れない（R09 未達・P10 の契約変更としてレビューが必要）' }),
